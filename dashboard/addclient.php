...
if($errormsg != "")
{
  echo $errormsg;
               ...
               <table class="table">
                 ...
                 <tr><th>Gender</th><td><input type="radio" name="gender" id="gender" value="Female"> Female <input type="radio" name="gender" value="Male" id="gender"> Male</td></tr>
                 ...
                 <tr><th>Genotype</th><td><input class="form-control" name="genotype" id="genotype">
                 </td></tr>
                 <tr><th>Blood Group</th><td><input class="form-control" name="blood_group" id="blood_group"></td></tr>
                 ...
                 <tr><th>Profile Picture</th><td>
                   <div class="fileupload fileupload-new" data-provides="fileupload">
                      ...
                      <div>
                        ...
                        <input type="file" class="default" name="imageUpload" accept="image/*;capture=camera"/>
                        </span>
                      </div>
                    </div> </td></tr>
                 <tr><th></th><td><button type="submit" class="btn btn-primary btn-block"> <i class="fa fa-check"></i> Add Record</button></td></tr>
               </table>
             </div>
