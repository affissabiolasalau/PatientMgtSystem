...
<br>
             ...
             <div class="col-md-6 profile-text card-body">
               <table class="table table-striped">
                 <tr><th>Date</th><td><?php echo date('Y M, d', strtotime($date_added)); ?></td></tr>
                 <tr><th>Symptoms</th><td><?php echo $symptoms; ?></td></tr>
                 <tr><th>Diagnosis</th><td><?php echo $diagnosis; ?></td></tr>
                 <tr><th>Files</th><td><?php echo $files; ?></td></tr>
                 <tr><td colspan="2"><a href="history.php?deletehistory=<?php echo $id;?>" class="btn btn-danger btn-sm btn-block">Delete History</a></td></tr>
               </table>
             </div>
